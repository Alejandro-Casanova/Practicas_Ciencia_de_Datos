...
plot(datosCSV$altura, datosCSV$peso, xlab = 'altura', ylab = 'peso', col = 3, pch = 16, cex = 1)
RectaRegresion2 <- lm(datosCSV$peso~datosCSV$altura)
